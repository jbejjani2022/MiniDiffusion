...
This is a U-Net based model to predict noise $\textcolor{lightgreen}{\epsilon_\theta}(x_t, t)$.

U-Net processes a given image by progressively lowering (halving) the feature map resolution and then
increasing the resolution. There are pass-through connection at each resolution.
